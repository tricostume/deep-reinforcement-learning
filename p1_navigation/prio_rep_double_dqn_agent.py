...
REPLAY_BETA = 0.5       # beta used for prioritized replay
REPLAY_BETA_INCREMENT = 0.000003
...
class Agent():
    ...
    def __init__(self, state_size, action_size, hidden_size, seed, checkpoint=None):
